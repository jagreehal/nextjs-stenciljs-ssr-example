...
const BUILD = /* component-library */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, attachStyles: true, cloneNodeFix: false, cmpDidLoad: true, cmpDidRender: false, cmpDidUnload: false, cmpDidUpdate: true, cmpShouldUpdate: false, cmpWillLoad: true, cmpWillRender: false, cmpWillUpdate: true, connectedCallback: false, constructableCSS: false, cssAnnotations: true, cssVarShim: false, devTools: false, disconnectedCallback: true, dynamicImportShim: false, element: false, event: true, hasRenderFn: true, hostListener: false, hostListenerTarget: false, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: false, hydrateClientSide: true, hydrateServerSide: true, hydratedAttribute: false, hydratedClass: true, isDebug: false, isDev: false, isTesting: false, lazyLoad: true, lifecycle: true, lifecycleDOMEvents: false, member: true, method: false, mode: false, observeAttribute: true, profile: false, prop: true, propBoolean: false, propMutable: false, propNumber: true, propString: true, reflect: false, safari10: false, scoped: true, scriptDataOpts: false, shadowDelegatesFocus: false, shadowDom: true, shadowDomShim: true, slot: true, slotChildNodesFix: false, slotRelocation: true, state: true, style: true, svg: false, taskQueue: true, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: true, vdomKey: false, vdomListener: true, vdomPropOrAttr: true, vdomRef: false, vdomRender: true, vdomStyle: false, vdomText: true, vdomXlink: false, watchCallback: true };
...
const createElm = (e, t, o, n) => {
 ...
 let l;
 return t ? ((l = safeCall(s, "componentWillLoad"))) : ((l = safeCall(s, "componentWillUpdate"))), n(), then(l, (() => updateComponent(e, s, t)));
...
const Result = ({ result }) => {
  return (hAsync("div", { class: "result" }, hAsync("div", null, hAsync("a", { href: result.html_url, target: "_blank" }, result.full_name), "\uD83C\uDF1F", hAsync("strong", null, result.stargazers_count)), hAsync("p", null, result.description)));
};
class FetchExample {
  constructor(hostRef) {
...
class MyComponent {
  ...
  render() {
    return (hAsync("div", { class: "message" }, "Hello, World! I'm ", this.getText(), " - Initial Count=", this.count, " - Component Count=", this.counter, hAsync("button", { onClick: () => this.buttonHandler() }, "+"), hAsync("hr", null), hAsync("div", null, "Date - ", this.date.toLocaleTimeString()), hAsync("div", null, hAsync("slot", null))));
  }
...
class ScopedExample {
  ...
  render() {
    return (hAsync("div", { class: "text" }, "Hello, my name is ", this.first, " ", this.last));
  }
...
class SlotExample {
  ...
  render() {
    return (hAsync("div", null, hAsync("div", null, "Above the slot"), hAsync("slot", null), hAsync("div", null, "Below the slot")));
  }
  static get cmpMeta() { return {
    "$flags$": 4,
...
class SlotScopedExample {
  ...
  render() {
    return (hAsync(Host, null, hAsync("div", { class: "text" }, "Above the slot"), hAsync("slot", null), hAsync("div", { class: "text" }, "Below the slot")));
  }
