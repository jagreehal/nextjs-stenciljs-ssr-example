...
class ComponentWithEvent {
  ...
  render() {
    return (hAsync("div", null, hAsync("label", null, "Greeting"), hAsync("input", { class: "mb-shadow-4", type: "text", onChange: (e) => (this.greeting = e.target.value), value: this.greeting }), hAsync("h2", { class: "mb-shadow-4" }, "Greeting message will be ", this.greeting, " ", this.message), hAsync("button", { onClick: this.handleClick }, "Announce")));
  }
  static get style() { return componentWithEventCss; }
...
class MyComponent$2 {
  ...
  render() {
    return hAsync("div", null, "Child - ", this.childMessage, " ");
  }
  static get style() { return childComponentCss; }
  static get cmpMeta() { return {
    "$flags$": 2,
...
const myComponentCss = ".sc-my-component-h{color:rgb(48, 48, 48)}h3.sc-my-component{margin-top:2rem}.blue.sc-my-component{color:blue}.green.sc-my-component{color:green}.todo-item.sc-my-component{padding:10px;border-bottom:1px solid var(--todo-item-border, black)}";
...
class MyComponent$1 {
  ...
  render() {
    return (hAsync(Host, null, "Hello, World! I'm ", this.getText(), hAsync("div", null, hAsync("h3", null, "Change Local State"), this.count, " -", " ", hAsync("button", { class: "green", onClick: () => this.click() }, "Click"))));
  }
...
class MyComponent {
  ...
  render() {
    return (hAsync("div", null, hAsync("div", null, "Parent - ", this.parentMessage), hAsync("div", null, hAsync("child-component", { childMessage: this.childMessage }))));
  }
  static get style() { return parentComponentCss; }
  static get cmpMeta() { return {
    "$flags$": 2,
